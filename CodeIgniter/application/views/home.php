...
<div id ="search_result">
    ...
    <center>
        <div class="well">
            <h3><?php if (isset($welcome)) {
    echo $welcome;
} ?></h3>
            <div class="">
                <h4><?php if (isset($welcome_text)) {
    echo $welcome_text;
} ?></h4>
            </div>
        </div>
            ...
            <?php if (isset($locations)) : foreach ($locations as $row) : ?>
                    <div class="span3">
                        <a href="<?php echo base_url(); ?>index.php/search_controller/getCategories?location=<?php echo html_escape($row->location_id); ?>" class="" data-toggle="tooltip" data-placement="right" data-animation="false" id="basic-tooltip">
                            <h5><?php echo html_escape($row->location_name) . "  (" .
                            ...
                            <div class="span3">
                                ...
                                <a href="<?php echo base_url(); ?>index.php/search_controller/getCategories?category=<?php echo html_escape($row->catogory_id); ?>" >
                                    ...
                                    if ($row->catogory_id == 0) {
                                        ?>
                                        <div class="alert alert-info"><?php if (isset($vehicle)) {
                                            echo $vehicle;
                                        } ?></div>    
...
<?php endif; ?> 
    ...
    <table class="table table-striped">
        <tr>
            ...
            <td>
                <h4><?php if (isset($sell_fast)) {
    echo $sell_fast;
} ?></h4>
                <a><?php if (isset($sell_fast)) {
    echo $sell_fast;
} ?></a><br>

            </td>
            <td>
                <h4><?php if (isset($about_us)) {
    echo $about_us;
} ?></h4>
                <a><?php if (isset($about_us)) {
    echo $about_us;
} ?></a><br>
                <a><?php if (isset($terms)) {
    echo $terms;
} ?></a><br>
                <a><?php if (isset($privacy_policy)) {
    echo $privacy_policy;
} ?></a><br>
            </td>
            <td>
                <h4><?php if (isset($help_support)) {
    echo $help_support;
} ?></h4>
                <a><?php if (isset($faq)) {
    echo $faq;
} ?></a><br>
                <a><?php if (isset($contact_us)) {
    echo $contact_us;
} ?></a><br>
            </td>
